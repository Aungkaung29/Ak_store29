...
<body>
    <h1>Product List <span style="color: blue">(Latkar)</span></h1> <a href="history.php">History</a>
    ...
    <table id="product_table">
        ...
        <tbody id="product_body">
			...
			$productid = htmlspecialchars($array['Parent_Product_ID'], ENT_QUOTES, 'UTF-8');
             $latkar_id = htmlspecialchars($array['latkar_ID'], ENT_QUOTES, 'UTF-8');
 $quantity_pp = htmlspecialchars($array['Quantity_Per_Package'], ENT_QUOTES, 'UTF-8');
                    echo '<tr>';
                    ...
                    ?>
                   <td><a href="ExtractingPackage.php?PID=<?php echo $productid ?>
                   &QCTN=<?php echo $quantity_pp ?>&Pname=<?php echo $array['Product_Name'] ?>&LTP=<?php echo $latkar_id ?>">Add to လက်လီ</a></td>
                    <?php
 ...
 $quantity_pp = htmlspecialchars($array['Quantity_Per_Package'], ENT_QUOTES, 'UTF-8');
                    ...
                    if (empty($array['Parent_Product_Name'])) {
                        ...
                        echo '<td><a href="Product_Latli_restock.php?PID=' . htmlspecialchars($array['Parent_Product_ID'], ENT_QUOTES, 'UTF-8') . '">' . htmlspecialchars($array['Parent_Product_Name'], ENT_QUOTES, 'UTF-8') . '</a></td>';
                    }
                    ?>
                     <td><a href="ExtractingPackage.php?PID=<?php echo $productid ?>
                   &QCTN=<?php echo $quantity_pp ?>&Pname=<?php echo $array['Product_Name'] ?>&LTP=<?php echo $latkar_id ?>">Add to လက်လီ</a></td>
